...
ALLOWED_HOSTS = ['tiaara.shop', 'www.tiaara.shop']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'tiaraornament@gmail.com'
EMAIL_HOST_PASSWORD = 'kvstocuwnbgexuvm'
DEFAULT_FROM_EMAIL = 'tiaraornament@gmail.com'
EMAIL_USE_SSL=False
